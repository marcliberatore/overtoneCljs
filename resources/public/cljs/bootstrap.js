...
cljs.core._with_meta["function"] = function(a, b) {
  return cljs.core.with_meta.call(null, function() {
    if(void 0 === cljs.core.t3087) {
      cljs.core.t3087 = {};
      cljs.core.t3087 = function(a, b, c) {
        this.meta = a;
        this.f = b;
        this.meta3088 = c;
      ...
      cljs.core.t3087.cljs$lang$type = !0;
      cljs.core.t3087.cljs$lang$ctorPrSeq = function() {
        return cljs.core.list.call(null, "cljs.core/t3087")
      };
      cljs.core.t3087.cljs$lang$ctorPrWriter = function(a, b) {
        return cljs.core._write.call(null, b, "cljs.core/t3087")
      };
      var c = cljs.core.t3087.prototype, d = function(a, b) {
      ...
      cljs.core.t3087.prototype.cljs$core$Fn$ = !0;
      cljs.core.t3087.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
...
overtoneinterface.client.main.button = function(a) {
  ...
  b], !0));
  a.setAttribute("crateGroup", group__3037__auto___3059);
  return a
};
    ...
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, c)) {
          ...
          return cljs.core.cons.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'label", "\ufdd0'action", "\ufdd0'param"], {"\ufdd0'label":"" + cljs.core.str(d), "\ufdd0'action":"play-note", "\ufdd0'param":d}), b.call(null, cljs.core.rest.call(null, c)))
        }
        return null
      }
    }, null)
...
overtoneinterface.client.main.control_buttons = cljs.core.PersistentVector.fromArray([cljs.core.ObjMap.fromObject(["\ufdd0'label", "\ufdd0'action", "\ufdd0'param"], {"\ufdd0'label":"start", "\ufdd0'action":"start-dub", "\ufdd0'param":""}), cljs.core.ObjMap.fromObject(["\ufdd0'label", "\ufdd0'action", "\ufdd0'param"], {"\ufdd0'label":"stop", "\ufdd0'action":"stop-dub", "\ufdd0'param":""})], !0);
overtoneinterface.client.main.populate = function(a, b) {
  for(var c = cljs.core.seq.call(null, b);;) {
    if(c) {
      var d = cljs.core.first.call(null, c);
      jayq.core.append.call(null, a, overtoneinterface.client.main.button.call(null, d));
      c = cljs.core.next.call(null, c)
    }else {
      return null
    }
...
jayq.core.delegate.call(null, overtoneinterface.client.main.$body, overtoneinterface.client.main.button, "\ufdd0'click", function(a) {
  a.preventDefault();
  var b = jayq.core.$.call(null, this), a = jayq.core.data.call(null, b, "\ufdd0'action"), b = jayq.core.data.call(null, b, "\ufdd0'param"), b = cljs.core._EQ_.call(null, b, "") ? cljs.core.PersistentVector.EMPTY : cljs.core.PersistentVector.fromArray([b], !0);
  return fetch.remotes.remote_callback.call(null, a, b, null)
});
