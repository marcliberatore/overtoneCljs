...
var u = cljs.core.nth.call(null,vec__3986,1,null);
...
var xhr__delegate = function (route,content,callback,p__3987){
var vec__3990 = p__3987;
var opts = cljs.core.nth.call(null,vec__3990,0,null);
var req = (new goog.net.XhrIo());
var vec__3991 = fetch.core.parse_route.call(null,route);
var method = cljs.core.nth.call(null,vec__3991,0,null);
var uri = cljs.core.nth.call(null,vec__3991,1,null);
...
if (goog.isDef(var_args)) {
  p__3987 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 3),0);
} 
return xhr__delegate.call(this, route, content, callback, p__3987);
};
xhr.cljs$lang$maxFixedArity = 3;
xhr.cljs$lang$applyTo = (function (arglist__3992){
var route = cljs.core.first(arglist__3992);
var content = cljs.core.first(cljs.core.next(arglist__3992));
var callback = cljs.core.first(cljs.core.next(cljs.core.next(arglist__3992)));
var p__3987 = cljs.core.rest(cljs.core.next(cljs.core.next(arglist__3992)));
return xhr__delegate(route, content, callback, p__3987);
});
