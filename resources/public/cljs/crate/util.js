...
var G__3871__delegate = function (x,xs){
return (function (s,more){
while(true){
if(cljs.core.truth_(more))
{{
var G__3872 = [cljs.core.str(s),cljs.core.str(as_str.call(null,cljs.core.first.call(null,more)))].join('');
...
var G__3871 = function (x,var_args){
var xs = null;
if (goog.isDef(var_args)) {
  xs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return G__3871__delegate.call(this, x, xs);
};
G__3871.cljs$lang$maxFixedArity = 1;
G__3871.cljs$lang$applyTo = (function (arglist__3874){
var x = cljs.core.first(arglist__3874);
var xs = cljs.core.rest(arglist__3874);
return G__3871__delegate(x, xs);
});
...
return clojure.string.join.call(null,"&",(function (){var iter__2540__auto__ = (function iter__3879(s__3880){
return (new cljs.core.LazySeq(null,false,(function (){
var s__3880__$1 = s__3880;
while(true){
if(cljs.core.seq.call(null,s__3880__$1))
{var vec__3882 = cljs.core.first.call(null,s__3880__$1);
var k = cljs.core.nth.call(null,vec__3882,0,null);
var v = cljs.core.nth.call(null,vec__3882,1,null);
return cljs.core.cons.call(null,[cljs.core.str(crate.util.url_encode_component.call(null,k)),cljs.core.str("="),cljs.core.str(crate.util.url_encode_component.call(null,v))].join(''),iter__3879.call(null,cljs.core.rest.call(null,s__3880__$1)));
} else
{return null;
}
break;
...
url.cljs$lang$applyTo = (function (arglist__3883){
