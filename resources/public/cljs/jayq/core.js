...
;
jQuery.prototype.apply = (function (self__,args3884){
...
var hide__delegate = function ($elem,p__3886){
var vec__3888 = p__3886;
var speed = cljs.core.nth.call(null,vec__3888,0,null);
var on_finish = cljs.core.nth.call(null,vec__3888,1,null);
return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__3886 = null;
if (goog.isDef(var_args)) {
  p__3886 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return hide__delegate.call(this, $elem, p__3886);
};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__3889){
var $elem = cljs.core.first(arglist__3889);
var p__3886 = cljs.core.rest(arglist__3889);
return hide__delegate($elem, p__3886);
});
...
var show__delegate = function ($elem,p__3890){
var vec__3892 = p__3890;
var speed = cljs.core.nth.call(null,vec__3892,0,null);
var on_finish = cljs.core.nth.call(null,vec__3892,1,null);
return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__3890 = null;
if (goog.isDef(var_args)) {
  p__3890 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return show__delegate.call(this, $elem, p__3890);
};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__3893){
var $elem = cljs.core.first(arglist__3893);
var p__3890 = cljs.core.rest(arglist__3893);
return show__delegate($elem, p__3890);
});
...
var toggle__delegate = function ($elem,p__3894){
var vec__3896 = p__3894;
var speed = cljs.core.nth.call(null,vec__3896,0,null);
var on_finish = cljs.core.nth.call(null,vec__3896,1,null);
return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__3894 = null;
if (goog.isDef(var_args)) {
  p__3894 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return toggle__delegate.call(this, $elem, p__3894);
};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__3897){
var $elem = cljs.core.first(arglist__3897);
var p__3894 = cljs.core.rest(arglist__3897);
return toggle__delegate($elem, p__3894);
});
...
var fade_out__delegate = function ($elem,p__3898){
var vec__3900 = p__3898;
var speed = cljs.core.nth.call(null,vec__3900,0,null);
var on_finish = cljs.core.nth.call(null,vec__3900,1,null);
return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__3898 = null;
if (goog.isDef(var_args)) {
  p__3898 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return fade_out__delegate.call(this, $elem, p__3898);
};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__3901){
var $elem = cljs.core.first(arglist__3901);
var p__3898 = cljs.core.rest(arglist__3901);
return fade_out__delegate($elem, p__3898);
});
...
var fade_in__delegate = function ($elem,p__3902){
var vec__3904 = p__3902;
var speed = cljs.core.nth.call(null,vec__3904,0,null);
var on_finish = cljs.core.nth.call(null,vec__3904,1,null);
...
return fade_in__delegate.call(this, $elem, p__3902);
};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__3905){
var $elem = cljs.core.first(arglist__3905);
var p__3902 = cljs.core.rest(arglist__3905);
return fade_in__delegate($elem, p__3902);
});
...
var slide_up__delegate = function ($elem,p__3906){
var vec__3908 = p__3906;
var speed = cljs.core.nth.call(null,vec__3908,0,null);
var on_finish = cljs.core.nth.call(null,vec__3908,1,null);
return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__3906 = null;
if (goog.isDef(var_args)) {
  p__3906 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return slide_up__delegate.call(this, $elem, p__3906);
};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__3909){
var $elem = cljs.core.first(arglist__3909);
var p__3906 = cljs.core.rest(arglist__3909);
return slide_up__delegate($elem, p__3906);
});
...
var slide_down__delegate = function ($elem,p__3910){
var vec__3912 = p__3910;
var speed = cljs.core.nth.call(null,vec__3912,0,null);
var on_finish = cljs.core.nth.call(null,vec__3912,1,null);
return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__3910 = null;
if (goog.isDef(var_args)) {
  p__3910 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return slide_down__delegate.call(this, $elem, p__3910);
};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__3913){
var $elem = cljs.core.first(arglist__3913);
var p__3910 = cljs.core.rest(arglist__3913);
return slide_down__delegate($elem, p__3910);
});
...
var closest__delegate = function ($elem,selector,p__3914){
var vec__3916 = p__3914;
var context = cljs.core.nth.call(null,vec__3916,0,null);
...
return closest__delegate.call(this, $elem, selector, p__3914);
};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__3917){
var $elem = cljs.core.first(arglist__3917);
var selector = cljs.core.first(cljs.core.next(arglist__3917));
var p__3914 = cljs.core.rest(cljs.core.next(arglist__3917));
return closest__delegate($elem, selector, p__3914);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__3920){
var map__3922 = p__3920;
...
var request = map__3922__$1;
var contentType = cljs.core._lookup.call(null,map__3922__$1,"\uFDD0'contentType",null);
var data = cljs.core._lookup.call(null,map__3922__$1,"\uFDD0'data",null);
var ct = jayq.core.__GT_content_type.call(null,contentType);
return (function (p1__3919_SHARP_){
if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_.call(null,ct)))
{return cljs.core.assoc.call(null,p1__3919_SHARP_,"\uFDD0'data",cljs.core.pr_str.call(null,data));
} else
{return p1__3919_SHARP_;
}
}).call(null,(function (p1__3918_SHARP_){
if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__3918_SHARP_,"\uFDD0'contentType",ct);
} else
{return p1__3918_SHARP_;
}
}).call(null,request));
});
...
;
jayq.core.xhr = (function xhr(p__3923,content,callback){
var vec__3925 = p__3923;
var method = cljs.core.nth.call(null,vec__3925,0,null);
var uri = cljs.core.nth.call(null,vec__3925,1,null);
...
var unbind__delegate = function ($elem,ev,p__3926){
var vec__3928 = p__3926;
var func = cljs.core.nth.call(null,vec__3928,0,null);
...
return unbind__delegate.call(this, $elem, ev, p__3926);
};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__3929){
var $elem = cljs.core.first(arglist__3929);
var ev = cljs.core.first(cljs.core.next(arglist__3929));
var p__3926 = cljs.core.rest(cljs.core.next(arglist__3929));
return unbind__delegate($elem, ev, p__3926);
});
...
var on__delegate = function ($elem,events,p__3930){
var vec__3932 = p__3930;
var sel = cljs.core.nth.call(null,vec__3932,0,null);
var data = cljs.core.nth.call(null,vec__3932,1,null);
var handler = cljs.core.nth.call(null,vec__3932,2,null);
return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__3930 = null;
if (goog.isDef(var_args)) {
  p__3930 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return on__delegate.call(this, $elem, events, p__3930);
};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__3933){
var $elem = cljs.core.first(arglist__3933);
var events = cljs.core.first(cljs.core.next(arglist__3933));
var p__3930 = cljs.core.rest(cljs.core.next(arglist__3933));
return on__delegate($elem, events, p__3930);
});
...
var one__delegate = function ($elem,events,p__3934){
var vec__3936 = p__3934;
var sel = cljs.core.nth.call(null,vec__3936,0,null);
var data = cljs.core.nth.call(null,vec__3936,1,null);
var handler = cljs.core.nth.call(null,vec__3936,2,null);
return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__3934 = null;
if (goog.isDef(var_args)) {
  p__3934 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return one__delegate.call(this, $elem, events, p__3934);
};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__3937){
var $elem = cljs.core.first(arglist__3937);
var events = cljs.core.first(cljs.core.next(arglist__3937));
var p__3934 = cljs.core.rest(cljs.core.next(arglist__3937));
return one__delegate($elem, events, p__3934);
});
...
var off__delegate = function ($elem,events,p__3938){
var vec__3940 = p__3938;
var sel = cljs.core.nth.call(null,vec__3940,0,null);
var handler = cljs.core.nth.call(null,vec__3940,1,null);
return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__3938 = null;
if (goog.isDef(var_args)) {
  p__3938 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return off__delegate.call(this, $elem, events, p__3938);
};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__3941){
var $elem = cljs.core.first(arglist__3941);
var events = cljs.core.first(cljs.core.next(arglist__3941));
var p__3938 = cljs.core.rest(cljs.core.next(arglist__3941));
return off__delegate($elem, events, p__3938);
});
...
done.cljs$lang$applyTo = (function (arglist__3942){
var deferred = cljs.core.first(arglist__3942);
var fns_args = cljs.core.rest(arglist__3942);
...
fail.cljs$lang$applyTo = (function (arglist__3943){
var deferred = cljs.core.first(arglist__3943);
var fns_args = cljs.core.rest(arglist__3943);
...
always.cljs$lang$applyTo = (function (arglist__3944){
var deferred = cljs.core.first(arglist__3944);
var fns_args = cljs.core.rest(arglist__3944);
